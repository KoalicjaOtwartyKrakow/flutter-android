...
import 'application/guest/guest_list_bloc.dart' as _i12;
...
import 'infrastructure/host/host_repository.dart' as _i9;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i8.GuestRepository>(
      () => _i8.GuestRepository(get<_i7.ApiClient>()));
  gh.factory<_i9.HostRepository>(
      () => _i9.HostRepository(get<_i7.ApiClient>()));
  gh.factory<_i10.AccommodationFormRepository>(
      () => _i10.AccommodationFormRepository(get<_i7.ApiClient>()));
  gh.factory<_i11.GuestFormBloc>(
      () => _i11.GuestFormBloc(get<_i8.GuestRepository>()));
  gh.factory<_i12.GuestListBloc>(
      () => _i12.GuestListBloc(get<_i8.GuestRepository>()));
  gh.factory<_i13.HostBloc>(() => _i13.HostBloc(get<_i9.HostRepository>()));
  gh.factory<_i14.AccommodationFormBloc>(() =>
      _i14.AccommodationFormBloc(get<_i10.AccommodationFormRepository>()));
  return get;
}
