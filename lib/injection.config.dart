...
import 'infrastructure/host/host_repository.dart' as _i8; // ignore_for_file: unnecessary_lambdas
...
_i1.GetIt $initGetIt(_i1.GetIt get, {String? environment, _i2.EnvironmentFilter? environmentFilter}) {
  ...
  gh.factory<_i8.HostRepository>(() => _i8.HostRepository(get<_i7.ApiClient>()));
  gh.factory<_i9.AccommodationFormRepository>(() => _i9.AccommodationFormRepository(get<_i7.ApiClient>()));
  gh.factory<_i10.HostBloc>(() => _i10.HostBloc(get<_i8.HostRepository>()));
  gh.factory<_i11.AccommodationFormBloc>(() => _i11.AccommodationFormBloc(get<_i9.AccommodationFormRepository>()));
  return get;
}
